...
<body>
  ...
  $query= "SELECT SUM(qn*pr) 'total' FROM sell";
  $res=mysqli_query($con,$query);
  $data=mysqli_fetch_array($res);

  echo "TOTAL SELL=".$data['total'];
...
$qn=$_POST['qn'];
$pr=$_POST['pr'];
$query = mysqli_query($con,"INSERT INTO sell (id,pname,prname,qn,pr)VALUES('$id','$pname','$prname','$qn','$pr')");
}
 ?>
...
if(isset($_POST['delete'])){
  ...
  mysqli_query($con,"DELETE FROM sell WHERE id='$_POST[hidden]'");
}
$result=mysqli_query($con,"SELECT id,pname,prname,qn,pr,qn*pr FROM sell");
